      ...
      <div className={cn('w-full', className)}>
        ...
        <div className="relative flex items-center">
          <input
            ...
            className={cn(
              'w-full h-2 bg-secondary rounded-lg appearance-none cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
              '[&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-primary [&::-webkit-slider-thumb]:cursor-pointer [&::-webkit-slider-thumb]:transition-colors [&::-webkit-slider-thumb]:hover:bg-primary/90',
          ...
          />
          <div
            className="absolute h-2 rounded-l-lg bg-primary pointer-events-none"
