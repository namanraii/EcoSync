...
import type { OnboardingData, UserProfile, TrendData, Insight } from '@/types'
...
describe('Zustand Store Integration', () => {
  beforeEach(() => {
    ...
    store.resetStore()
    mockStorage.removeItem('ecosync-storage')
  })
  ...
  describe('Persistence', () => {
    it('should persist and rehydrate state', () => {
      ...
      const stored = mockStorage.getItem('ecosync-storage')
