...
import { AlertTriangle, TrendingUp, Leaf, Zap, Users, ShoppingBag, Monitor } from 'lucide-react'
...
const CATEGORY_COLORS: Record<EmissionCategory, string> = {
  ...
  diet: 'bg-yellow-50 text-yellow-700 border-yellow-200',
  energy: 'bg-blue-50 text-blue-700 border-blue-200',
  digital: 'bg-purple-50 text-purple-700 border-purple-200',
  consumption: 'bg-pink-50 text-pink-700 border-pink-200',
}
